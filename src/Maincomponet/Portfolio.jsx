...
const Portfolio = () => {
  return (
    ...
    <img src={F2} alt="Hover Image" className="hover-image" />
  ...
  <div className="col-md-4 image-container">
    <img src={F1} alt="Hover Image" className="hover-image" />
    <div className="text-overlay texthover"> 
    <h2>Amazon Scribe</h2>
    <p>A Simmpel bloge user thisse A Simmpel bloge user thisseA Simmpel bloge user thisse</p>
    <button1 className=''>Click Me </button1>
  ...
  <div className="col-md-4 image-container">
    <img src={F4} alt="Hover Image" className="hover-image" />
    <div className="text-overlay texthover"> 
    <h2>Amazon Scribe</h2>
    <p>A Simmpel bloge user thisse A Simmpel bloge user thisseA Simmpel bloge user thisse</p>
    <button1 className=''>Click Me </button1>
    ...
    <div className="col-md-4 image-container">
    <img src={F5} alt="Hover Image" className="hover-image" />
    <div className="text-overlay texthover"> 
    <h2>Amazon Scribe</h2>
    <p>A Simmpel bloge user thisse A Simmpel bloge user thisseA Simmpel bloge user thisse</p>
    <button1 className=''>Click Me </button1>
  ...
  <div className="col-md-4 image-container">
    <img src={Port2} alt="Hover Image" className="hover-image" />
    <div className="text-overlay texthover"> 
    <h2>Amazon Scribe</h2>
    <p>A Simmpel bloge user thisse A Simmpel bloge user thisseA Simmpel bloge user thisse</p>
    <button1 className=''>Click Me </button1>
  ...
  <div className="col-md-4 image-container">
    <img src={Port} alt="Hover Image" className="hover-image" />
    <div className="text-overlay texthover"> 
    <h2>Amazon Scribe</h2>
    <p>A Simmpel bloge user thisse A Simmpel bloge user thisseA Simmpel bloge user thisse</p>
    <button1 className=''>Click Me </button1>
